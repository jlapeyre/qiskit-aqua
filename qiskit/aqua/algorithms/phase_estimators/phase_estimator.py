    ...
    **Reference:**
    ...
    def _compute_phases(self, circuit_result: Result) -> Union[numpy.ndarray, dict]:
        ...
        `HamiltonianPEResult`.
         ...
         2) If the backend samples bitstrings, then the counts are first retreived as a dict.  The
        ...
        if self._quantum_instance.is_statevector:
            ...
            # The diagonal is real, so imaginary part should be zero.
            phases = evaluation_density_matrix.diagonal().real
        else:
